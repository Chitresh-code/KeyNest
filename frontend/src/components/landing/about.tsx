    ...
    <section id="about" className="py-20 bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 mb-16"
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-gray-100 rounded-lg p-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 mb-4">Open Source</div>
                  <div className="text-4xl font-bold text-green-600 mb-2">0</div>
                  <div className="text-sm text-gray-600 mb-4">Vendor Lock-in</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {values.map((value, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="h-full text-center hover:shadow-lg transition-shadow duration-300 border-0 bg-white/60 backdrop-blur-sm">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 mb-12"
        >
